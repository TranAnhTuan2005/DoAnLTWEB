    ...
    <div class="collection-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="category-list">
                ...
                <li><a href="SanPham-NguCoc.html"><b>Ngũ cốc</b></a></li>
            ...
            <div class="collection-product-grid">
                ...
                <div class="collection-product-item">
                    <div class="collection-product-image">
                        <img src="image/collection/bot-gao-lut-me-den-ho-tro-giam-can.png" alt="Bột gạo lứt mè đen hỗ trợ giảm cân"><!-- Hình ảnh minh họa-->
                ...
                <div class="collection-product-item">
                    <div class="collection-product-image">
                        <img src="image/collection/chao-hat-vo-cho-tre-em.png"
