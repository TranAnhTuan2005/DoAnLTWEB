...
<head>
    <meta charset="UTF-8">
    <title>Sản phẩm - trà gạo lứt</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-2 rounded-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Trà gạo lứt</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <div class="collection-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="category-list">
                ...
                <li><a href="SanPham-TraGaoLut.html"><b>Trà gạo lứt</b></a></li>
            </ul>
            ...
            <div class="collection-product-grid">
                ...
                <div class="collection-product-item">
                    <div class="collection-product-image">
                        <img src="image/collection/tra-gao-lut-dau-den.png"
                ...
                <div class="collection-product-item">
                    <div class="collection-product-image">
                        <img src="image/collection/tra-thao-moc.png"
                             alt="Trà thảo mộc"><!-- hình ảnh minh họa -->
                        <div class="collection-overlay"><!-- Hover để hiển thị-->
                            <button class="collection-add-to-cart">🛒 THÊM VÀO GIỎ</button>
                            <button class="collection-view-btn"
                                    onclick="openModal('./image/collection/tra-thao-moc.png', 'Trà thảo mộc', '159,000đ')">👁
                                XEM NHANH</button>
                        </div>
                    </div>
                    <h3>Trà thảo mộc</h3>
