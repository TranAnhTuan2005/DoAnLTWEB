            ...
            <div class="col-12 col-md-6">
                ...
                <form id="registerForm" class="register-form" novalidate>
                    <div class="mb-3">
                        ...
                        <input id="lastName" name="lastName" type="text" class="form-control custom-input" placeholder="Họ" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="email" name="email" type="email" class="form-control custom-input highlight-input" placeholder="Email" required>
                    </div>
