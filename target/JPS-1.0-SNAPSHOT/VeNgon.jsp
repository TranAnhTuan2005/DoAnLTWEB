...
<main class="about-page">
        ...
        <div class="container">
            <div class="row align-items-start">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mt-3">
                        <a href="SanPham-TatCa.html" class="btn btn-outline-success me-2">Xem tất cả sản phẩm</a>
    ...
    <section class="about-ending py-5 bg-light text-center">
        <div class="container">
            ...
            <a href="SanPham-TatCa.html" class="btn btn-success px-4 py-2 rounded-pill">Khám phá sản phẩm</a>
        </div>
    </section>
